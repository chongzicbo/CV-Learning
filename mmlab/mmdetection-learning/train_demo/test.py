...
def parse_args():
    ...
    parser.add_argument(
        "--config",
        default="/home/bocheng/dev/mylearn/CV-Learning/mmdetection-learning/train_demo/config/mask-rcnn_r50-caffe_fpn_ms-poly-1x_balloon.py",
        help="test config file path",
    )
    parser.add_argument(
        "--checkpoint",
        default="/home/bocheng/dev/mylearn/CV-Learning/mmdetection-learning/train_demo/work_dirs/mask-rcnn_r50-caffe_fpn_ms-poly-1x_balloon/epoch_12.pth",
